...
(function($) {
	...
	BannerSlideshow.defaults = {
		...
		nextPrev: true, // If true, will render next and previous links inside the selector defined below
		...
		selectors: {
			...
			pagination: '.slide-images', // The container for pagination
			nextPrev: '.overlay .wrap:eq(0)' // The container for next and previous links
		},
