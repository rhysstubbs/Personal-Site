<footer id="footer">
    <section class="top-footer">
        <div class="container">
            <div class="row">
                <div class="item-list">
                    <div class="item col-md-6 col-xs-12" data-height-group="3">
                    ...
                    <div class="item col-md-6 col-xs-12" data-height-group="3">
                        ...
                        <button class="btn" type="button" role="button">Sign Up</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="bottom-footer">
        <div class="container">
            <div class="row">
                <nav class="nav col-md-18 col-sm-16 col-xs-24" role="navigation">
                ...
                <p class="copy col-md-6 col-sm-8 col-xs-24">&copy; Sound in Theory 2014</p>
            </div>
        </div>
