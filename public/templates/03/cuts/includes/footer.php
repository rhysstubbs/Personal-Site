	<footer id="footer">
		<section class="top outer">
			<div class="wrap">
				...
				<div class="col4">
					<div class="item" data-height-group="footer1">
						<div class="border">
							<h3 class="heading">Logos</h3>
							<ul>
								<li><a href="#"><img src="../assets/images/temp/100x35.png" /></a></li>
								<li><a href="#"><img src="../assets/images/temp/100x35.png" /></a></li>
							</ul>
						</div>
					</div>
					...
					<div class="item" data-height-group="footer1">
						<div class="border">
							...
							<ul class="social">
								...
								<li><a href="#"><i class="sprite google"></i></a></li>
		...
		<section class="bottom outer h-nopad">
			<div class="wrap">
