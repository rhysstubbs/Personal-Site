<?php include 'includes/header.php' ?>
	...
	<section id="generic">
		<div class="container pad-bot">
			...
			<div class="row">
				<div class="pull-right col-md-6 col-sm-8 col-xs-24">
				...
				<div class="editor col-md-18 col-sm-16 col-xs-24">
					...
					<table class="responsive-table">
						...
						<tr>
							<td data-th="Headings">table content</td>
							<td data-th="Inside">table content</td>
							<td data-th="The">table content</td>
							<td data-th="Table">table content</td>
						</tr>
						<tr>
							<td data-th="Headings">table content</td>
							<td data-th="Inside">table content</td>
